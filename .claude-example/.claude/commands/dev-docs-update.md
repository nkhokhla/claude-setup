...
- Update README.md if project setup changed
- Update `.claude/skills/project-guidelines/SKILL.md` if new patterns emerged
- Add to `docs/` if new features or architecture added
